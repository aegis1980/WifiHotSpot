...
public class TestMeActivity extends AppCompatActivity {
     ...
     */
    private final View.OnTouchListener mOnButtonTouchListener = new View.OnTouchListener() {
        @Override
        public boolean onTouch(View view, MotionEvent motionEvent) {

            if (motionEvent.getAction()==MotionEvent.ACTION_DOWN) {
                if (view.getId() == R.id.turnon_button) {
                    onTurnOnButtonPressed();
                } else if (view.getId() == R.id.turnoff_button) {
                    onTurnOffButtonPressed();
                }
            }
